...
<a href="<?php echo U('Ptsys/bannerAdd', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btnGrayS vm bigbtn">
...
<td><?php echo ($hostlist["picurl"]); ?></td>
<td><?php echo ($hostlist["sort"]); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$hostlist["addtime"])); ?></td> 
<td class="norightborder">
	<a href="<?php echo U('Ptsys/bannerSet',array('token'=>$token,'id'=>$hostlist['id']));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Ptsys/bannerDel',array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a>
</td>
