...
<script src="<?php echo STATICS;?>/artDialog/plugins/iframeTools.js"></script>
  <div class="content"> 
   <div class="cLineB"> 
    <h4>商品分类设置</h4> 
    <a href="<?php echo U('Ptsys/cat',array('token'=>$token,'parentid'=>$_GET['parentid']));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
   <form class="form" method="post" action="" enctype="multipart/form-data"> 
    <input type="hidden" name="cat_id" value="<?php echo ($set["cat_id"]); ?>" /> 
    <input type="hidden" name="parent_id" value="<?php echo ($set["parent_id"]); ?>" /> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
	  ...
	  <?php if($parentid > 0): ?><tr> 
       ...
       <tr> 
        ...
        <td><input type="text" name="cat_name" value="<?php echo ($set["cat_name"]); ?>" class="px" style="width:400px;" /></td> 
       </tr> 
       <tr> 
        <th>Logo地址：</th> 
        <td>
        <input type="text" name="cat_img" value="<?php echo ($set["cat_img"]); ?>" id="pic" class="px" style="width:400px;" />  
        <script src="<?php echo STATICS;?>/upyun.js"></script>
        <a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td> 
       </tr> 

       <tr> 
        <th>排序：</th> 
        <td>
        <input type="text" id="sort" name="sort_order" value="<?php echo ($set["sort_order"]); ?>" class="px" style="width:50px;" />  数字越大排越前（大于等于0的整数）
        </td> 
       </tr>
       ...
       <tr> 
        ...
        <td>
        是
        <input type="radio" name="is_show" value="1" <?php if(($set["is_show"]) == "1"): ?>checked<?php endif; ?>/>  
        否
        <input type="radio" name="is_show" value="0" <?php if(($set["is_show"]) == "0"): ?>checked<?php endif; ?>/>  
      </td> 
       </tr>
       ...
       <a href="<?php echo U('Ptsys/cat',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
