...
<a href="###" onclick="showIntroDetail(<?php echo ($o["order_id"]); ?>)">详细</a>&nbsp;&nbsp;
<!-- <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Ptsys/deleteOrder',array('token'=>$token,'id'=>$o['order_id'],'dining'=>$isDining));?>');">删除</a></td> -->
