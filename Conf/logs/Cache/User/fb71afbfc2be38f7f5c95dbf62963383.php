...
<table class="userinfoArea" style=" margin:0;float:left" border="0" cellspacing="0" cellpadding="0" width="50%"><tbody>
<tr>
<th width="120">微信名：</th>
...
<td><img src="<?php echo ($member["headimgurl"]); ?>" width="80"></td>
</tr>
<tr>
<th width="120">关注时间：</th>
<td><?php echo (date('Y-m-d',$member["reg_time"])); ?></td>
</tr>
...
<td><?php echo intval($totalScore);?>&nbsp;分</td>
</tr> -->
<tr>
<th width="120">累计购买：</th>
<td><?php echo ($info["totalMoney"]); ?>&nbsp;元</td>
</tr>

<tr>
<th width="120">拼团购买：</th>
<td><?php echo ($info['teamMoney']); ?>&nbsp;元</td>
</tr>

<tr>
<th width="120">单独购买：</th>
<td><?php echo ($info['alonMoney']); ?>&nbsp;元</td>
</tr>

<tr>
<th width="120">退款总金额：</th>
<td><?php echo ($info['refunMoney']); ?>&nbsp;元</td>
</tr>

<tr>
<th width="120">拼团次数：</th>
<td><?php echo $info['teamtimes'];?>&nbsp;次</td>
</tr>

<tr>
<th width="120">单独购买次数：</th>
<td><?php echo ($info['alonetimes']); ?>&nbsp;次</td>
</tr>

<tr>
<th width="120">退款次数：</th>
<td><?php echo ($info['refuntimes']); ?>&nbsp;次</td>
</tr>
