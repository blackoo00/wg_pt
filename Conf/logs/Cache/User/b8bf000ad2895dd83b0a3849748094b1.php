...
<div class="tab">
<ul>
<li class=" <?php if((ACTION_NAME) == "index"): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Ptsys/index',array('token'=>$token));?>">商品列表</a></li>
<li class=" <?php if((ACTION_NAME) == "cat"): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Ptsys/cat',array('token'=>$token));?>">商品分类</a></li>
<li class=" <?php if((ACTION_NAME) == "banner"): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Ptsys/banner',array('token'=>$token));?>">轮播图</a></li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
...
<a href="<?php echo U('Ptsys/goodsAdd',array('cat_id'=>$_GET['cat_id']));?>" title="新增商品" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">新增商品</a>

<input type="text" id="msgSearchInput" class="txt" placeholder="输入相关信息搜索" name="searchkey" value="<?php echo ($_REQUEST['searchkey']); ?>">
...
<td><?php echo ($hostlist["goods_name"]); ?></td>
<!-- <td><?php echo ($hostlist["goods_sn"]); ?></td> -->
<td><?php echo ($hostlist["shop_price"]); ?></td>
<td><?php echo ($hostlist["team_num"]); ?></td>
<td><?php echo ($hostlist["team_price"]); ?></td>

<td>
<?php if($hostlist["is_best"] == 1): ?><image src="<?php echo STATICS;?>/images/yes.gif"></image>
	<?php else: ?>
	<image src="<?php echo STATICS;?>/images/no.gif"></image><?php endif; ?>
</td>

<td>
<?php if($hostlist["is_new"] == 1): ?><image src="<?php echo STATICS;?>/images/yes.gif"></image>
	<?php else: ?>
	<image src="<?php echo STATICS;?>/images/no.gif"></image><?php endif; ?>
</td>

<td>
<?php if($hostlist["is_hot"] == 1): ?><image src="<?php echo STATICS;?>/images/yes.gif"></image>
	<?php else: ?>
	<image src="<?php echo STATICS;?>/images/no.gif"></image><?php endif; ?>
</td>

<td>
<?php if($hostlist["is_on_sale"] == 1): ?><image src="<?php echo STATICS;?>/images/yes.gif"></image>
	<?php else: ?>
	<image src="<?php echo STATICS;?>/images/no.gif"></image><?php endif; ?>
</td>


<td><?php echo ($hostlist["goods_type"]); ?></td>
<td><?php echo ($hostlist["sales_num"]); ?></td>
<td><?php echo ($hostlist["goods_number"]); ?></td>


<td class="norightborder">
	<a href="<?php echo U('Ptsys/goodsSet',array('token'=>$token,'goods_id'=>$hostlist['goods_id']));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Ptsys/goodsDel',array('goods_id'=>$hostlist['goods_id'],'token'=>$token));?>');">删除</a>
