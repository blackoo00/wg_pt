...
<td><input type="text" name="startNums" value="<?php echo ($set["startNums"]); ?>" class="px" style="width:50px;" id="startNums">&nbsp;个
 ...
 <tr>
<th style="width:150px;">引导关注URL：</th>
<td><input type="text" name="followUrl" value="<?php echo ($set["followUrl"]); ?>" class="px" style="width:450px;" id="followUrl">
</td>
</tr>
<tr>
<th>头部背景图片：</th>
<td>
<?php if($set['topbg'] != ''): ?><img class="thumb_img" id="picurl2_src" src="<?php echo ($set['topbg']); ?>" style="max-height:100px;"><br/><?php endif; ?>
<input type="text" name="topbg" value="<?php echo ($set["topbg"]); ?>" class="px" onclick="document.getElementById('picurl2_src').src=this.value;" id="picurl2" style="width:300px;">
 <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl2',700,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl2')">预览</a></td>
</tr>
                <TR>
