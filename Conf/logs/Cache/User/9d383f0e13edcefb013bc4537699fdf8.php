...
<li class="current tabli" id="tab2"><a href="<?php echo U('Order/team',array('token'=>$token,'dining'=>$isDining));?>">团购列表</a></li>
<li class="tabli" id="tab2"><a href="<?php echo U('Order/order',array('token'=>$token,'dining'=>$isDining));?>">订单列表</a></li>
...
<!-- <a href="###" onclick="showIntroDetail(<?php echo ($o["order_id"]); ?>)">详细</a> 
 -->&nbsp;&nbsp;
<a href="<?php echo U('Order/order',array('teamid' => $o['team_sign']));?>">团员订单详情</a>
