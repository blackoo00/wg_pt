                ...
                <tr></tr>
                  ...
                  <td><?php echo ($list["mobile"]); ?></td>
                   ...
                   <td class="norightborder">
                    <a href="<?php echo U('Member/orders',array('user_id'=>$list['user_id']));?>" title="查看订单">历史订单</a> |
   <!--                  <a href="<?php echo U('Member/setMember',array('user_id'=>$list['user_id']));?>" title="修改">修改</a>|  -->
              
                    <a href="<?php echo U('Member/memberDtail',array('user_id'=>$list['user_id']));?>" title="详细">详细</a>
                   </td>
