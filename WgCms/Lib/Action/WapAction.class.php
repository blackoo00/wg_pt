...
class WapAction extends BaseAction
{
    ...
    protected function _initialize()
    {
        ...
        if($_GET['wecha_id']){
        	...
        	session('wecha_id',$_GET['wecha_id']);
        }
    ...
    public function sendMessage($touser,$title,$content,$url){
    	...
    	$re = $this->api_notice_increment('https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token='.$access_token_p,$data_p);
    	Log::write("ccsql2=".$re,'DEBUG');
    }
